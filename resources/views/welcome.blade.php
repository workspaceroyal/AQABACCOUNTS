...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="relative flex justify-center min-h-screen py-4 bg-gray-100 items-top gray:bg-gray-900 sm:items-center sm:pt-0" style="background-image: url('https://dupulse.com/wp-content/uploads/2023/11/welcomebackground-1024x576.png');
