 ...
 <div class="page-content">
                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="m-0 breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active">Daily Deposit Report</li>
                                        </ol>
                                    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div>
                <div class="p-2">
                    <h3 class="font-size-16"><strong>Daily Deposit Report
...
<div class="table-responsive">
    <table class="table">
        ...
        <tr>
            ...
            <td class="text-center"><strong>Deposit No </strong></td>
