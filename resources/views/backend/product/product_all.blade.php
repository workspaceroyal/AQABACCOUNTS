...
@section('admin')
 ...
 <div class="page-content">
    ...
    <a href="{{ route('product.add') }}" class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right;"><i class="fas fa-plus-circle"> মাস ও সন যুক্ত করুন </i></a> <br>  <br>
