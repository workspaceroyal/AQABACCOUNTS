                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">আয়ের উৎস ভিত্তিক রিপোর্ট</h4>

                                    <div class="page-title-right">
                                        <ol class="m-0 breadcrumb">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);"> </a></li>
                                            <li class="breadcrumb-item active">আয়ের উৎস ভিত্তিক রিপোর্ট</li>
                                        </ol>
                                    </div>
            ...
            <div class="row">
                <div class="mt-4 col-6">
                    <address>
                        ...
                        alquranacademybangladesh@gmail.co
                    </address>
                </div>
...
<div class="table-responsive">
    ...
    <h3 class="text-center"><strong>আয়ের উৎস : </strong> {{ $allData['0']['supplier']['name'] }} </h3>
